...
export const faqs = [
  ...
  {q:"How do I choose the right Wedge?",a:"It’s two choices. Step 1, your size — the colour tells you which is which: Blue is Small/Medium (5'6\" and under), Red is Medium/Large (5'6\" and above), and Black is X-Large (6'0\" and above). Step 2, your density — Standard is the original dense foam with a 250 lb weight limit, and Extra Firm is the more supportive foam for 250 lbs and above. The size and density steps are laid out on the product page, or contact the team for help choosing."},
...
export function HomePage() {return <SiteShell><main id="main"><Hero/><BuyerContexts/><WorksFromTheFront/><FeatureSection/><RitualSection/><CollectionSection/><BuyDirect/><CustomerVoices/><PractitionerStrip/><NewsletterSection/><FAQSection/></main></SiteShell>;}
