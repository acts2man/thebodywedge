...
export function HomePage() {return <SiteShell><main id="main"><Hero/><BuyerContexts/><FeatureSection/><WorksFromTheFront/><RitualSection/><CollectionSection/><BuyDirect/><CustomerVoices/><PractitionerStrip/><NewsletterSection/><FAQSection/></main></SiteShell>;}
